...
class CajaController extends Controller
{
    ...
    public function movimiento(Request $request)
    {
        ...
        $movimiento = Caja::{$metodo}($request->cantidad, $request->referencia);
    ...
    {
        $movimientosSinCerrar = Caja::sinCerrar()->get();

        if ($movimientosSinCerrar->isEmpty()) {
    ...
    {
        $query = CorteCaja::with('user')->orderBy('fecha', 'desc');
